...
Generate 4-6 insights per analysis. Fewer, deeper, more comparative insights are better than many shallow ones. Prioritize cross-domain insights (connecting 2+ data sources) over single-source observations. **ORDER INSIGHTS BY WOW FACTOR — the insight that would make the athlete stop and say "I had no idea" MUST be first.** Use this ranking framework: (1) SURPRISE — a counterintuitive finding or hidden pattern the athlete couldn't have guessed, (2) ACTIONABILITY — something they can change TODAY that will measurably improve performance, (3) PERSONAL RECORD or ANOMALY — a milestone or red flag that demands attention, (4) CROSS-DOMAIN DISCOVERY — a connection between two data sources no single app could reveal, (5) STRONG SIGNAL — high correlation or large effect size. A moderate correlation that reveals something unexpected beats a strong correlation that confirms the obvious. "Your bedtime matters more than sleep duration for next-day EF" is more valuable than "more sleep = better performance." Lead with insight, not just statistics. Every analysis should include at least one from the "dataGaps" array suggesting additional integrations that would unlock richer analysis. Choose the most relevant categories from the full 30+ category catalog based on what's most meaningful for this specific ride and athlete context — do not force insights into fixed category buckets.
