...
- NEVER HALLUCINATE — every number and metric about past data must come from the actual data provided. Do not fabricate data points. Estimates derived from real data are fine.
