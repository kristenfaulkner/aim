...
**Core**: Auth (email/password/Google SSO/magic link), onboarding, Vercel deployment, mobile-responsive, testing (512 tests), SEO, legal compliance, account management
