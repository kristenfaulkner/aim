...
export default function DataProcessing() {
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.text, fontFamily: font }}>
      <SEO title="Data Processing Agreement" path="/data-processing" description="AIM Data Processing Agreement. Details on how we process your fitness and health data as a data processor." />
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px 100px" }}>
        ...
        <ul style={ul}>
          ...
          <li style={li}><strong style={{ color: T.text }}>AI Processing and Analysis:</strong> Automated analysis of athlete performance, health, and recovery data to generate personalized insights, training recommendations, and cross-domain pattern detection. <strong style={{ color: T.text }}>Named Sub-Processor: Anthropic, PBC</strong> (San Francisco, CA, USA) — provides Claude AI language model services. Data is transmitted via encrypted API calls, processed in real-time for analysis generation, and is <strong style={{ color: T.text }}>not used for model training</strong>. Anthropic maintains SOC 2 Type II certification and processes data under a Data Processing Agreement with AIM. Categories of data processed: activity metrics, health biomarkers, sleep data, body composition, training load, and historical performance trends.</li>
          <li style={li}><strong style={{ color: T.text }}>SMS and Communication Services:</strong> Delivery of AI-generated coaching insights, morning readiness summaries, and interactive coaching conversations via SMS. <strong style={{ color: T.text }}>Named Sub-Processor: Twilio, Inc.</strong> (San Francisco, CA, USA) — provides programmable messaging infrastructure. Data transmitted: User phone number and message content only. Twilio maintains SOC 2 Type II, ISO 27001, and HIPAA certifications. Messages are transmitted over encrypted channels and are not stored by Twilio beyond delivery confirmation logs.</li>
        </ul>
