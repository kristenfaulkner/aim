...
/**
 * Thumbs up/down feedback for a single AI insight.
 *
 * Props:
...
export default function InsightFeedback({
  ...
  const submit = useCallback(async (value) => {
    ...
    if (newValue === null) return; // toggled off, no API call needed
  ...
  }, [feedback, activityId, source, insightIndex, insight, onFeedback]);
