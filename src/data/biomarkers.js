...
export const biomarkerDB = {
  ...
  ferritin: {
    ...
    actionLow: "Iron-rich foods (red meat, spinach, lentils) may help support iron stores. Research suggests vitamin C enhances iron absorption, while calcium and coffee may inhibit it. Ask your doctor about whether iron supplementation is appropriate for your levels — retesting in 8-12 weeks is typical.",
    actionHigh: "High ferritin can indicate inflammation or iron overload. Cross-reference with hs-CRP — if CRP is also elevated, ferritin may be artificially high. Consider discussing persistently elevated levels (>300) with your physician.",
  },
  hemoglobin: {
  ...
  iron: {
    ...
    actionLow: "Low serum iron often accompanies low ferritin. Consider increasing dietary iron intake and discuss supplementation with your doctor. Research suggests iron is best absorbed on an empty stomach with vitamin C. Retest fasting in the morning for consistency.",
  ...
  tibc: {
    ...
    actionHigh: "High TIBC is a classic sign of iron deficiency — your body is upregulating iron transport capacity. Consider discussing iron supplementation and dietary changes with your doctor.",
  },
  transferrinSat: {
    ...
    actionLow: "Transferrin saturation <20% indicates functional iron deficiency. Ask your doctor about iron supplementation — research suggests taking it with vitamin C on an empty stomach may improve absorption. Retesting in 8 weeks is typical.",
  ...
  vitaminD: {
    ...
    actionLow: "Ask your doctor about vitamin D supplementation — many sports medicine practitioners suggest 2,000-5,000 IU daily with a fat-containing meal for athletes. Sun exposure (15-20 min when possible) also supports vitamin D levels. Athletes in northern latitudes are especially at risk in winter. Retesting in 8-12 weeks is typical.",
    actionHigh: "Levels >100 ng/mL carry a risk of toxicity (rare with supplementation). Consider reducing supplementation and retesting in 4 weeks. Discuss with your doctor.",
  },
  vitB12: {
    ...
    actionLow: "Ask your doctor about B12 supplementation — research commonly cites 500-1000 mcg methylcobalamin daily. Vegans and vegetarians are at particularly high risk of deficiency since B12 is found almost exclusively in animal products. Sublingual or injected forms may be better absorbed.",
  ...
  folate: {
    ...
    actionLow: "Folate-rich foods include leafy greens, legumes, citrus fruits, and fortified grains. If dietary intake may be insufficient, ask your doctor about methylfolate supplementation (studies commonly reference 400-800 mcg daily). Retesting in 8 weeks is typical.",
  ...
  testosterone: {
    ...
    actionLow: "Cross-reference with training load and caloric intake. Common causes include overtraining, underfueling (especially dietary fats), poor sleep, and chronic stress. Consider discussing with an endocrinologist if levels remain persistently low despite lifestyle adjustments.",
  ...
  cortisol: {
    ...
    actionLow: "Very low AM cortisol may indicate adrenal insufficiency or severe overtraining. Consider consulting your physician and discussing whether reducing training volume may help.",
  ...
  tsh: {
    ...
    actionHigh: "High TSH may indicate hypothyroidism or chronic underfueling — common in athletes with restricted diets. Consider evaluating caloric intake, and discuss with your physician if TSH remains elevated.",
  },
  freeT3: {
    ...
    actionLow: "Low Free T3 often signals insufficient caloric intake relative to training load. Research suggests increasing daily calories (especially carbohydrates) and temporarily reducing training volume may help. Consider discussing with your doctor and retesting in 6-8 weeks.",
  ...
  hsCRP: {
    ...
    actionHigh: "If consistently >1.0, consider evaluating omega-3 intake, sleep quality, and training load. If >3.0, this may indicate infection or injury — discuss with your physician. Ferritin levels should be interpreted cautiously when CRP is elevated.",
  },
  ...
  creatineKinase: {
    ...
    actionHigh: "If >1000 U/L, consider reducing training volume and consulting your doctor. If >5000, seek medical attention promptly (rhabdomyolysis risk). Adequate hydration is important. If consistently elevated at rest, training load may be too high.",
  },
  ...
  hba1c: {
    ...
    actionLow: "Very low HbA1c (<4.0%) may indicate chronic underfueling or frequent hypoglycemia during training. Consider evaluating carbohydrate intake around workouts.",
    actionHigh: "HbA1c 5.7-6.4% may indicate prediabetes. Research suggests reducing refined sugars and increasing fiber intake may help. If >6.5%, discuss with your physician.",
  },
  ...
  totalCholesterol: {
    ...
    actionLow: "Very low cholesterol can impair hormone production (testosterone, cortisol). Consider evaluating whether dietary fat intake is adequate (research suggests 25-35% of calories).",
    actionHigh: "If >240 mg/dL, check HDL and LDL breakdown — high total cholesterol with high HDL is less concerning. Research suggests omega-3s, fiber, and plant sterols may support healthier lipid profiles.",
  },
  ldl: {
    dbColumn: "ldl_mg_dl",
    ...
    actionHigh: "If >130 mg/dL, research suggests soluble fiber (oats, beans), omega-3 fatty acids, and plant sterols may help. Consider discussing with your doctor. Regular endurance exercise is one of the most effective LDL-lowering interventions.",
  },
  hdl: {
    dbColumn: "hdl_mg_dl",
    ...
    actionLow: "Low HDL despite regular exercise is unusual. Consider evaluating dietary omega-3 intake (fatty fish, walnuts, flaxseed), sleep quality, and stress levels. Some research associates moderate alcohol consumption with higher HDL, though this should be discussed with your doctor.",
  ...
  triglycerides: {
    ...
    actionHigh: "If >150, consider evaluating refined carbohydrate/sugar intake, omega-3 consumption, and alcohol use. Discuss with your doctor. Note: fasted blood draw is essential — non-fasted samples are artificially elevated.",
  },
  ...
  creatinine: {
    ...
    actionHigh: "Mildly elevated creatinine in muscular athletes is normal. If >1.5 mg/dL, consider ensuring adequate hydration and discussing chronic NSAID use with your doctor. Persistently elevated values may warrant kidney function assessment (GFR).",
  },
  bun: {
    dbColumn: "bun_mg_dl",
    name: "BUN",
    ...
    actionLow: "Low BUN may indicate inadequate protein intake. Research suggests endurance athletes benefit from 1.2-2.0g protein per kg of body weight daily.",
    actionHigh: "If elevated, check hydration status first (dehydration raises BUN). If well-hydrated and BUN persists >25, consider discussing protein intake with your doctor.",
  },
  ...
  alt: {
    ...
    actionHigh: "If elevated, first rule out exercise-induced elevation (retest after 48h rest). If persistently >50, consider reviewing your supplement stack (especially pre-workouts, fat burners) and alcohol intake with your physician. Some supplements can be hepatotoxic.",
  },
  ast: {
    dbColumn: "ast_u_l",
    name: "AST",
  ...
  magnesium: {
    ...
    actionLow: "Ask your doctor about magnesium supplementation — research commonly cites 200-400mg magnesium glycinate or citrate before bed. Dietary sources include dark chocolate, nuts, spinach, and avocado. Some studies suggest magnesium glycinate may offer additional sleep benefits.",
  ...
  zinc: {
    ...
    actionLow: "Ask your doctor about zinc supplementation — research commonly references 15-30mg zinc picolinate daily (taken with food to reduce nausea). Dietary sources include oysters, red meat, pumpkin seeds, and chickpeas. Note: studies suggest exceeding 40mg/day may deplete copper.",
    actionHigh: "High zinc supplementation (>40mg/day) can deplete copper and interfere with iron absorption. Consider discussing dose adjustment with your doctor.",
  },
};
